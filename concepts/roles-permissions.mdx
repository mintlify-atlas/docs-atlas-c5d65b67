...
description: "A 5-tier role system controls endpoint access using JWT middleware guards that verify identity and role membership on every protected request."
---
