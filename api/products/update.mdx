---
title: "Update Product — POST /api/product/update/:productId"
sidebarTitle: "Update Product"
description: "Modify an existing product — update fields, replace images, and calculate a discounted price from a percentage. Requires admin authentication."
---
