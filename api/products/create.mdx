---
title: "POST /api/product/create — Create a new product"
sidebarTitle: "Create Product"
description: "Create a clothing product with a title, pricing, images, color options, available sizes, and a shirt-fit type."
---
...
<ParamField body="productImg" type="file[]">
  One or more product image files. Uploaded using the `productImg` field key as a multi-file upload. Images are stored on disk and their paths are saved to the product record.
</ParamField>
