---
title: "Search and filter products by title or shirt type"
sidebarTitle: "Search Products"
description: "Two endpoints to find products: full-text title search with regex matching, and exact filtering by numeric shirt-type category."
---
...
<ResponseField name="pagination" type="object">
  ...
  <Expandable title="pagination fields">
    <ResponseField name="pag" type="string">
      The current page number as provided in the path.
    </ResponseField>
    <ResponseField name="perpage" type="number">
      The `pag` value from `req.body` as set by the `Paginate` middleware (reflects the raw page parameter).
    </ResponseField>
