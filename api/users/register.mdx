---
title: "POST /api/user/create — Register a new user"
sidebarTitle: "Register"
description: "Create a new user account by providing a name, email, and password. A verification email is sent automatically after registration."
---
