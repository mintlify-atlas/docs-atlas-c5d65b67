---
title: "Password recovery and update endpoints"
sidebarTitle: "Passwords"
description: "Recover a forgotten password using an emailed code, or update the current password when already authenticated with a valid token."
---
