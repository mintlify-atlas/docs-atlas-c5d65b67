...
description: "Update the authenticated user profile including name, address, phone number, and ID fields. Supports avatar image upload via multipart/form-data."
---
