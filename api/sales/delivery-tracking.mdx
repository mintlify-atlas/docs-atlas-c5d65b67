---
title: "POST /api/sale/status-delivery/:saleId — Add delivery tracking update"
sidebarTitle: "Delivery Tracking"
description: "Append a timestamped delivery event to an order's tracking history and push a real-time notification to the buyer."
---
