---
title: "POST /api/sale/status-change/:saleId — Update order payment status"
sidebarTitle: "Status Change"
description: "Change a sale's payment status, optionally decrement product stock on payment, and notify the buyer via push notification."
---
