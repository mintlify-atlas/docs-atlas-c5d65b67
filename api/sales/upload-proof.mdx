---
title: "Upload Payment Proof — POST /api/sale/laod-proof/:saleId"
sidebarTitle: "Upload Proof"
description: "Upload a payment screenshot to an order, triggering Validando status and sending an FCM push notification to all admin users with an active device token."
---
