---
title: "Configure Google Cloud Storage for image uploads"
...
Three environment variables control access to Google Cloud Storage. Set these in your `.env` file:
...
<ParamField path="CLIENT_ID" type="string" required>
  The OAuth 2.0 Client ID associated with your Google Cloud service account.
</ParamField>

<ParamField path="CLIENT_SECRET" type="string" required>
  The OAuth 2.0 Client Secret for the service account. Keep this out of version
  control.
</ParamField>
